	...
	<tr>
		<td width="7cm">
			...
			<table class="table-datos" width="7cm">
				...
				<tr>
					<td class="texto-title">N° de Documento</td>
				</tr>
				<tr>
					<td class="titleR1"><?= $model->cliente->tipo_documento ?> - <?= $model->cliente->nro_documento ?></td>
				</tr>
				...
				<tr>
					<td class="texto-title">Marca del Vehículo</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="texto-title">Modelo del Vehículo</td>
				</tr>
				<tr>
					<td class="titleR1"><?= $model->coche->modelo ?></td>
				</tr>

				<tr>
					<td class="texto-title">Matrícula del Vehículo</td>
				</tr>
				<tr>
