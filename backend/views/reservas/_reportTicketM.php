...
?>
	<div style="page-break-after: always;">
		...
		<table style="margin-top: 15px; margin-left: -3px; table-layout: fixed; width: 100%;">
			<tr>
			...
			<tr>
				<td colspan="2" align="center" style="width: 7cm; text-transform: uppercase; padding-top: 10px">
					Marca - Modelo
					<div style="width: 7cm; font-size: 20px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align: center;">
