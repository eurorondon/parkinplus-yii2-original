			...
			<table class="tablenot">
				...
				<tr>
				    <td class="celda content">
				    	...
				    	<!--</div>-->
    				        <div class="evalua">
                                 <a href="<?= Html::encode($urlEncuesta) ?>">Haga click para evaluarnos. (20 seg.)</a>
                            </div>
				    	<div class="fin">
				    		Esperamos volver a verle muy pronto, <br>
				    		El equipo de parkingplus.es<br><br>
							<b style="color: #961007">Parking Plus - Tu vuela, nosotros aparcamos !!</b>
				    	</div>			    				    			    	
				    	<br><br>		    	
				    </td>
				</tr>
