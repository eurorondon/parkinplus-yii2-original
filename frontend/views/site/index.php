        ...
        <g id="Landingpage_final_desktop_IT" transform="translate(-860.000000, -82.000000)">
            <g id="Group-13" transform="translate(822.000000, 82.000000)">
                <g id="Group-3" transform="translate(38.000000, 0.000000)">
                    ...
                    <rect id="Rectangle" fill="#951104" x="10.8965517" y="10.8965517" width="136.206897" height="136.206897" rx="68"></rect>
                 
                    <use id="Rectangle" stroke="#951104" mask="url(#mask-2)" stroke-width="8" stroke-dasharray="2" xlink:href="#path-1"></use> 
                    <text id="per-prenotare" transform="translate(86.618749, 96.891934) rotate(-20.000000) translate(-86.618749, -96.891934)" font-family="Open Sans, sans-serif" font-size="15" font-weight="800" fill="#FFFFFF">
                        <tspan x="57.6187491" y="103.391934">
                            por dia
                        </tspan>
                    </text> 
                    <text id="3-MIN" transform="translate(76.579658, 71.109202) rotate(-20.2) translate(-76.579658, -71.109202)" font-family="Open Sans, sans-serif" font-size="50" font-weight="800" fill="#FFFFFF">
					...
					<div class="row d-flex align-items-center" id="calc_reserva" style="">
						<div class="col-sm-12 col-lg-12">
							<div class="card">
								...
								<div id="msg-fecha-parada" class="text-danger py-2 px-4" style="display:none">
...
<script>
	...
	function existeParada() {
		...
		$('#msg-fecha-parada').html("").css('display', 'none');
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (Number(data) == 1) {
					$('#msg-fecha-parada').html("Para la fecha de entrada o salia no tenemos plazas disponible").css('display', 'block');
					return null;
				}
