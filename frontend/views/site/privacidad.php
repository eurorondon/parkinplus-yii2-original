	...
	<div class="panel-body" style="padding: 10px 30px 20px 30px">
		<div class="row">
			<div class="col-lg-12">
				...
				<ul>
					<li>Nuestra denominación: Marichal4Parking S.L</li>
					<li>Nuestro CIF / NIF: B88537345</li>
					<li>Nuestra actividad principal: Empresa de alojamiento de vehículos (Parking)</li>
					<li>Nuestra dirección: C/ Miguel de Cervantes 10, CP 28860</li>
					<li>Nuestro teléfono de contacto: 603284800</li>
					<li>Nuestra dirección de correo electrónico de contacto: parkingplus01@gmail.com</li>
					<li>Nuestra página web: www.parkingplus.es</li>
				</ul>
