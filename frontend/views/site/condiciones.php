	...
	<div class="panel-body" style="padding: 10px 30px 20px 30px">
		<div class="row">
			<div class="col-lg-12">
				...
				<p align="justify">El contrato tiene por objeto regular las condiciones generales de prestación de los servicios ofrecidos por Marichal 4 Parking S.L, a través de www.parkingplus.es (en adelante, "Parking Plus").</p>
				...
				<p align="justify">También quedan excluidos desperfectos en piezas del vehículo por rotura o mal funcionamiento por desgaste de las mismas. Después de la devolución del vehículo la empresa no admitirá reclamación alguna.</p>  
			    ...
			    <p align="justify" style="margin-bottom: 20px">Sí al momento de la recogida o devolución del vehículo se produjera un pinchazo, en la rueda no será responsabilidad del parking ya que no depende de las habilidades o destrezas del conductor sino del Estado de la carretera o de las llantas del coche, también queda exento de responsabilidad el parking de las roturas de cristales o daños mecánicos</p>
			    
			    <p align="justify" style="margin-bottom: 20px">En caso de pérdida o extravío de la llave del coche en custodia el parking se hará cargo solo de la copia de la llave y no de los cambios de bombín oh desplazamiento para llevar al cliente a su domicilio ya que es deber del cliente contar con una copia de la llave para casos fortuitos.</p>
			    
			    <p align="justify" style="margin-bottom: 20px">Sí por motivos de tráfico y congestionamiento de servicios o por otra causa se retrasa la entrega o devolución del coche esto no será causa de incumplimiento de las obligaciones del cliente para pagar y dar por terminado el servicio. El servicio se considera terminado una vez el cliente haya pagado y se le devuelva por parte del operario (valet parking) la llave del coche. En el caso de negativa por parte del cliente de pagar el servicio no se entregará la llave del vehículo en custodia ya que se considera terminado el servicio cuando el cliente pague el importe correspondiente.</p>
			
			
			    <p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">DERECHO DE EXCLUSIÓN</p>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">CONDICIONES ECONÓMICAS Y FORMA DE PAGO</p>

				<ol>
					<li>Precio del servicio:</li><br>
					<ul>
						<li>
					...
					<li>Formas de Pago</li><br>
					
					<ul>
					    <li style="list-style: none;"><b>Los métodos de pago de PARKING PLUS son los siguientes:</b></li>
						<li>
							<p align="justify">Pago en metálico.</p>
						</li>
						<li>
							<p align="justify">Pago mediante tarjeta de crédito/débito en tpv físico.</p>
						</li>
					</ul>
				</ol>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">EXONERACIÓN DE RESPONSABILIDADES</p>
				
					<ol>
					<li><b>RECOGIDA DEL VEHÍCULO POR PARTE DE PARKING PLUS</b></li><br>
					<ul>
						<li>
					...
					<li><b>DEVOLUCIÓN DEL VEHÍCULO</b></li><br>
				...
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">POLITICAS DE CANCELACIÓN Y RESOLUCIONES PREVIAS DEL CONTRATO</p>
				...
				<p align="justify">Para darse de baja de envíos de comunicaciones publicitarias puede hacerlo enviando un email a parkingplus01@gmail.com.</p>	
				
				
				
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">CAUSAS DE DISOLUCIÓN DEL CONTRATO Y DESISTIMIENTO</p>

                <p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">Derecho de desistimiento</p>
                ...
                <p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">Disolución del contrato.</p>
                ...
                <p align="justify">A la disolución del contrato, el derecho a utilizar los Servicios cesará inmediatamente.</p>	
                
                <p align="justify">Serán causas de disolución de contrato:</p>
				
				<ul>
					<li>
						<p align="justify">La falsedad, en todo o en parte, de los datos suministrados en el proceso de contratación de cualquier servicio.</p>
					</li>
					<li>
						<p align="justify">También los casos de abuso de los servicios de soporte.</p>
					</li>
					<li>
						<p align="justify">Cualquier incumplimiento establecido a lo largo de las condiciones.</p>
					</li>
					<li>
						<p align="justify">La disolución implica la pérdida de sus derechos sobre el servicio contratado.</p>
					</li>
					
				</ul>
				
				
				<p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">RESOLUCION EXTRAJUDICIAL DE CONFLICTOS</p>

				<p align="justify">Asimismo, en los términos que se recogen en el artículo 14 del Reglamento UE 524/2013, sobre resolución de litigios en materia de consumo, se proporciona un enlace directo a la plataforma de resolución de litigios en línea: <b>https://ec.europa.eu/consumers/odr/main/index.cfm</b></p>	
				
				
                <p align="left" style="font-weight: bold; margin-bottom: 15px; margin-top: 30px; color: #921007">LEGISLACIÓN APLICABLE Y JURISDICCIÓN</p>
