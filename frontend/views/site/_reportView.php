	...
	<tr>
		<td width="7cm">
			...
			<table class="table-datos" width="7cm">
				...
				<tr>
					<td class="titleR1"><?= !empty($model->coche->marca) ? $model->coche->marca : 'N/D' ?></td>
				</tr>
				...
				<tr>
					<td class="titleR1" style="padding-bottom: 4px;"><?= !empty($model->coche->matricula)  ? $model->coche->matricula : 'N/D' ?></td>
				</tr>
			</table>
		</td>
		<td width="13cm">
