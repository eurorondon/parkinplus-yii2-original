						...
						<div class="counter__description">Recogida por<br> chofer</div>
                                ...
                                <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <ul class="list-unstyled services">
                                                ...
                                                <li>Traslado desde el aparcamiento a cualquier terminal.</li>
                                                <li>Traslado desde la terminal de llegada hasta el aparcamiento.</li>
					...
					<button type="submit" id="economic" class="btn"
						...
						<div class="counter__description">Recogida por<br> chofer</div>
                                ...
                                <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <ul class="list-unstyled services">
                                                <li>Plaza reservada</li>
                                                <li>Recogida y entrega del vehículo en la terminal.</li>
                                                <li class="noctur" style="display:none">Especial nocturnidad entre 00:30 y 03:45</li>
                                        </ul>
                                        <?= Html::button('más inf +', [
                                                'class' => 'btn btn-default btn-sm text-dark',
