                    ...
                    */
                    ...
                    if ($modelC->correo != null) {
                        try {
                            ...
                            return $this->redirect(['success', 'reserva' => $model->nro_reserva]);
                        }
                    }
    ...
    public function actionUpdate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $modelC->load(Yii::$app->request->post()) && $modelV->load(Yii::$app->request->post())) {
            ...
            $reservaAttrs = [
                ...
                'terminal_entrada', 'terminal_salida', 'nro_vuelo_regreso',
                'ciudad_procedencia', 'observaciones', 'factura', 'nif',
                'razon_social', 'direccion', 'cod_postal', 'ciudad',
                'provincia', 'pais', 'id_tipo_pago'
            ];
